...
int main(int argc, char** argv)
{
    ...
    // 需要输入一个视频
    const char* videopath = "./sample.mp4";

    // 输出的视频 demo.avi（标注了目标跟踪结果）会输出视频总帧数以及当前处理的帧数
    // Total frames: 1625, fps: 29
    //Init ByteTrack!
    //Processing frame 20 (2 fps)
    //Processing frame 40 (2 fps)
    //Processing frame 60 (2 fps)
    //
    //Processing frame 80 (2 fps)
    //Processing frame 100 (2 fps)
    //Processing frame 120 (2 fps)
    //Processing frame 140 (2 fps)
    //Processing frame 160 (2 fps)
    //Processing frame 180 (2 fps)
    //Processing frame 200 (2 fps)
    //Processing frame 220 (2 fps)
    //Processing frame 240 (2 fps)
    //Processing frame 260 (2 fps)
    //Processing frame 280 (2 fps)
    //Processing frame 300 (2 fps)
    //Processing frame 320 (2 fps)
