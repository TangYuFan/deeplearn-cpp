...
{
	string model_path = "./ppmattingv2_stdc1_human_480x640.onnx";
...
int main()
{
	...
	if (use_video)
	{
		cv::VideoCapture video_capture(0);  ///���Ե�����ͷ
		//cv::VideoCapture video_capture(images/3.mp4);  ///��Ƶ�ļ�
