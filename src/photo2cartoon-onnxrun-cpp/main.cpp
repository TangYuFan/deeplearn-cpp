...
private:
	...
	const int inpHeight = 384;   ///�߿�Ҳ���Դ�onnx�ļ�����
	...
	const int inpHeight_cartoon = 256;    ///�߿�Ҳ���Դ�onnx�ļ�����
...
{
	string model_path = "./minivision_head_seg.onnx";
//	std::wstring widestr = std::wstring(model_path.begin(), model_path.end());  ////windowsд��
	...
	model_path = "./minivision_female_photo2cartoon.onnx";
//	std::wstring widestr_cartoon = std::wstring(model_path.begin(), model_path.end());  ////windowsд��
	///OrtStatus* status_cartoon = OrtSessionOptionsAppendExecutionProvider_CUDA(sessionOptions_cartoon, 0);  ///���ʹ��cuda���٣���Ҫȡ��ע��

	sessionOptions_cartoon.SetGraphOptimizationLevel(ORT_ENABLE_BASIC);
	ort_session_cartoon = new Session(env_cartoon, model_path.c_str(), sessionOptions_cartoon);  ////windowsд��
	////ort_session_cartoon = new Session(env_cartoon, model_path.c_str(), sessionOptions_cartoon);  ////linuxд��
